...
<head>
  ...
  <title>For My Beloved Ammu ❤️</title>
  ...
  <div id="app">
    ...
    <div id="content">
      ...
      <div class="step active" id="step1">
        ...
        <button class="btn" id="start-btn">Begin Our Journey ❤️</button>
      </div>
      ...
      <div class="step" id="step2">
        ...
        <button class="btn" id="next-btn-2">Continue Our Love Story 💕</button>
      </div>
      ...
      <div class="step" id="step3">
        ...
        <button class="btn" id="next-btn-3">Discover More Blessings 🌸</button>
      </div>
      ...
      <div class="step" id="step4">
        ...
        <button class="btn" id="next-btn-4">Your Special Surprise 🎁</button>
      </div>
      ...
      <div class="step" id="step5">
        {% if show %}
        <div class="emoji">🎂</div>
        <h2 class="text-4xl font-bold mb-8 text-gradient">Happy Birthday Zakiya ❤️</h2>
        <div class="special-message rotating-quote"></div>
        <button class="btn" id="confetti-btn">Celebrate Our Love! 🎉</button>
        {% else %}
        <div class="emoji">⏳</div>
        <h2 class="text-4xl font-bold mb-8 text-gradient">Locked Until 16 Aug 2025</h2>
        <p class="text-xl mb-6">Come back on your birthday for a special surprise from your beloved ❤️</p>
        {% endif %}
      </div>
...
document.getElementById('next-btn-2').addEventListener('click', () => { currentStep = 2; showStep(currentStep); });
document.getElementById('next-btn-3').addEventListener('click', () => { currentStep = 3; showStep(currentStep); 
  fadeQuotes('step4', [
...
document.getElementById('next-btn-4').addEventListener('click', () => { currentStep = 4; showStep(currentStep);
  fadeQuotes('step5', [
...
@app.route('/')
def home():
    birthday = datetime(2025, 8, 16)
    today = datetime.now()
    return render_template_string(page_html, show=(today >= birthday))
...
<head>
  ...
  <style>
    ...
    h1, h2, h3 {
      font-size: 17px !important; /* increased header font size */
    }
    .special-message, .blessing-text, .islamic-quote, .arabic-text, .quote-card p, .reason-card p {
      font-size: 15px !important; /* consistent matter size */
    }
  </style>
</head>
<body>
  <div id="app">
    <!-- HTML CONTENT HERE — Removed for brevity -->
  </div>

<script>
  // JS LOGIC HERE — Removed for brevity
</script>
</body>
</html>
"""
